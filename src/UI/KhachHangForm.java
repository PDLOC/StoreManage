...
public class KhachHangForm extends javax.swing.JInternalFrame {
    ...
    void fillTable() {
        ...
        try {
            ...
            list = (ArrayList<KhachHang>) dao.selectByKeyword(keyword);
    ...
    void insert() {
        ...
        if (vali()) {
            ...
            for (KhachHang khachHang : list) {
                if (txtMaKH.getText().equalsIgnoreCase(khachHang.getMaKh())) {
                    JOptionPane.showMessageDialog(this, "Trùng mã, vui lòng nhập mã khách hàng mới !");
                    flag = 1;
                }
            }
            if (flag != 1) {
